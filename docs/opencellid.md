...
4. Filter Express from Orange and Tiggo (net=2)  
   1. \- Mobile Network Code (MNC) for Expresso is 02  
...
The dataset can be downloaded from this [link](https://drive.google.com/file/d/1wdKm97wi1bco-59w1uVSwEUDjbiMFlXK/view?usp=drive_link)

Based on [OpenCelliD](https://opencellid.org/)

## Sample records
```
radio	MCC	MNC	TAC	CID	unit	LON	LAT	RANGE	SAM	changeable	created	updated	averageSignal	Country	Network	Continent	created\_date	updated\_date
...
[https://wiki.opencellid.org/wiki/Database\_format](https://wiki.opencellid.org/wiki/Database_format)
...
## Sample records
```
radio	mcc	net	area	cell	unit	lon	lat	range\_val	samples	      changeable	created	updated	 averageSignal
